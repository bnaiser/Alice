...
$(document).ready(function(){
    ...
    const mostraMsgMes = (texto) =>{
        ...
        switch(texto){
            case "16/8": titulo = "16 de Agosto de 2023"; mensagem = "<p>Esse foi o dia que nos conhecemos pessoalmente! E tambem foi a primeira vez que nos beijamos 💜.</p><p>";break;
            case "20/8": titulo = "20 de Agosto de 2023"; mensagem = "<p>O dia que colocamos relacionamento no Facebook.<br>Tirando o fato que colocamos no mês e dia errado rs 💜💜</p>";break;
            case "final": titulo = "01 de Janeiro de 2024"; mensagem = "<p>O dia que colocamos pela primeira vez nossa aliança de namoro! 💜</p>";break;
        }
